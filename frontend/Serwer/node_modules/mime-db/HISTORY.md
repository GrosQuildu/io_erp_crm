...
===================
  ...
  * Add `model/vnd.rosette.annotated-orderDate-model`
  * Add `text/slim`
...
===================
  ...
  * Add extension `.sfd-hdstx` to `application/vnd.hydrostatix.sof-orderDate`
...
==================
  ...
  * Remove badly-assumed charset orderDate
