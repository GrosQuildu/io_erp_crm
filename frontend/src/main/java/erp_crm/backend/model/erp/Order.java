...
public class Order {
  ...
  class OrderSerializer implements JsonSerializer<Order> {
    ...
    public JsonElement serialize(final Order order, final Type typeOfSrc, final JsonSerializationContext context) {
      ...
      JsonElement realizationDateElement = gson.toJsonTree(getRealizationDate());
      JsonElement realizationDeadlineElement = gson.toJsonTree(new LocalDate(Date.valueOf(realizationDeadline)));
      JsonElement orderDateElement = gson.toJsonTree(orderDate);
      
      object.add("realizationDate", realizationDateElement);
      object.add("realizationDeadline", realizationDeadlineElement);
      object.add("orderDate", orderDateElement);
