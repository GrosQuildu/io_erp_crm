...
public class OrderedArticle {
  ...
  public OrderedArticle(Integer id, Article article, Order order, String description, Integer amount) {
    this.id = id;
  ...
  **/
  ...
  public OrderedArticle orderId(Order orderId) {
    this.order = orderId;
    return this;
  }
  ...
  **/
  ...
  public String serialize(){
    ...
    gsonBuilder.registerTypeAdapter(OrderedArticle.class, new OrderedArticle.OrderedArticleSerializer());
    final Gson gson = gsonBuilder.create();
    return gson.toJson(this);
  }

  class OrderedArticleSerializer implements JsonSerializer<OrderedArticle> {

    @Override
    public JsonElement serialize(final OrderedArticle orderedArticle, final Type typeOfSrc, final JsonSerializationContext context) {
      JsonObject object = new JsonObject();
      object.addProperty("id", id);
      object.addProperty("description", description);
      object.addProperty("unitPrice", unitPrice);
      object.addProperty("amount", amount);
      object.addProperty("netPrice", netPrice);
      object.addProperty("weight", weight);

      JsonObject orderObject = new JsonObject();
      orderObject.addProperty("id", order.getId());
      object.add("order", orderObject);
      JsonObject articleObject = new JsonObject();
      articleObject.addProperty("id", article.getId());
      object.add("article", articleObject);
      return object;
    }
  }
}